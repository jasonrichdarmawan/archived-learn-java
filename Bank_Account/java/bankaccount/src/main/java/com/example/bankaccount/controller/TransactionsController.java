...
public class TransactionsController {
  ...
  public ResponseEntity<?> getTransactions(@RequestHeader(value = "Authorization") String Authorization, @RequestBody Map json) {
    ...
    if (isVerified) {
      ...
      List<TransactionsModel> transactions = this.transactions.selectByStartEndDate(Account_Number, LocalDate.parse((String) json.get("Start")), LocalDate.parse((String) json.get("End")));
